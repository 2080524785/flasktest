function downloadImg(s, page, index, name) {
    // console.log(s+'_'+page+'_'+index)
    var img = document.getElementById(s+'_'+page+'_'+index); // 获取要下载的图片
...
function downloadAllPage(s, page){
    for(let i=1;i<= 30;i++){
        downloadImg(s, page, i, s+'_'+page+'_'+i);
    }

}
function downloadMore(s, ls){
